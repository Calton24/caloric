...
export default function LogWeightScreen() {
  ...
  const setCurrentWeightLbs = useProfileStore((s) => s.setCurrentWeightLbs);
  ...
  const handleSave = () => {
    ...
    // Sync latest weight to profile so plan calculations stay current
    setCurrentWeightLbs(units.toLbs(weight));
    ...
    if (appleHealthSyncEnabled && appleHealthWriteEnabled) {
      getHealthService()
        .writeWeight(units.toLbs(weight), new Date())
